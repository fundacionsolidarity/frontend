...
export const Header = async () => {
    ...
    return (
    <header className="relative w-full overflow-hidden bg-gradient-to-br from-yellow-300 via-orange-300 to-pink-300 p-4 shadow-md rounded-b-xl">
        {/* Elementos decorativos flotantes (ej. estrellas, burbujas) */}
        ...
        <div className="flex items-center">
            ...
            width={100}
            height={100}
            className="w-12 h-12 md:w-16 md:h-16 rounded-full mr-3 transform transition-transform duration-300 hover:scale-110 animate-bounce-once"
            />
